  ...
  <div class="flex justify-center">
    ...
    <button
      ...
      @click="
        [
          store.switchDark(),
          store.ui.primaryColor.includes('white') && !store.ui.dark
            ? store.setPrimaryColor(
                store.ui.primaryColor.replace('white', 'black')
              )
            : '',
          store.ui.primaryColor.includes('black') && store.ui.dark
            ? store.setPrimaryColor(
                store.ui.primaryColor.replace('black', 'white')
              )
            : '',
        ]
      "
